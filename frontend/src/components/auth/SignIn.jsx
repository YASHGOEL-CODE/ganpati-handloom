...
const SignIn = () => {
  ...
  // ── ADDED: Show success message from SignUp redirect ──
    ...
    <>
      <style>{`
        ...
        .si-orb1 {
          ...
          background: radial-gradient(circle, rgba(234,88,12,0.2) 0%, transparent 70%);
          top:-100px; left:-100px; animation: orbF 9s ease-in-out infinite;
        }
        .si-orb2 {
          position: absolute; width:280px; height:280px; border-radius:50%;
          background: radial-gradient(circle, rgba(249,115,22,0.16) 0%, transparent 70%);
          bottom:-60px; right:-60px; animation: orbF 12s ease-in-out infinite reverse;
        }
        @keyframes orbF { 0%,100%{transform:translate(0,0) scale(1)} 50%{transform:translate(16px,-16px) scale(1.08)} }
        .si-lc { position:relative; z-index:2; width:100%; max-width:400px; }
        .si-brand { display:flex; align-items:center; gap:12px; margin-bottom:36px; }
        .si-brand-ico {
          width:44px; height:44px; border-radius:12px;
          background:linear-gradient(135deg,#ea580c,#c2410c);
          display:flex; align-items:center; justify-content:center;
        ...
        .si-brand-lbl { color:#fb923c; font-size:12.5px; font-weight:600; letter-spacing:0.13em; text-transform:uppercase; }
        .si-h1 {
          font-family:'Playfair Display',serif;
        ...
        .si-sub { color:rgba(255,255,255,0.46); font-size:14.5px; line-height:1.68; margin-bottom:34px; }
        .si-feats { display:flex; flex-direction:column; gap:9px; }
        .si-feat {
          ...
          animation:featIn .55s ease both; opacity:0; transform:translateX(-14px); cursor:default;
        }
        .si-feat:nth-child(1){animation-delay:0.28s}
        .si-feat:nth-child(2){animation-delay:0.44s}
        .si-feat:nth-child(3){animation-delay:0.60s}
        @keyframes featIn { to{opacity:1;transform:translateX(0)} }
        .si-feat:hover { background:rgba(234,88,12,0.13); border-color:rgba(234,88,12,0.3); transform:translateX(5px); }
        .si-feat-ico { font-size:17px; flex-shrink:0; }
        .si-feat-txt { color:rgba(255,255,255,0.76); font-size:13px; font-weight:500; }
        .si-quote { margin-top:34px; color:rgba(255,255,255,0.18); font-size:11.5px; font-style:italic; letter-spacing:0.03em; }

        .si-right {
          width:50%; min-height:100vh; background:#0d0d0d;
          display:flex; align-items:center; justify-content:center;
          padding:48px 44px; flex-shrink:0;
        }
        .si-card {
          width:100%; max-width:410px;
          background:rgba(255,255,255,0.032); border:1px solid rgba(255,255,255,0.07);
          border-radius:22px; padding:38px 36px; backdrop-filter:blur(24px);
          box-shadow:0 28px 65px rgba(0,0,0,0.52), inset 0 1px 0 rgba(255,255,255,0.065);
          animation:cardIn .42s ease both; opacity:0; transform:translateY(16px);
        }
        @keyframes cardIn { to{opacity:1;transform:translateY(0)} }
        .si-ttl { font-family:'Playfair Display',serif; font-size:27px; font-weight:700; color:#fff; margin-bottom:5px; }
        .si-desc { font-size:13px; color:rgba(255,255,255,0.36); margin-bottom:26px; }
        .si-success {
          background:rgba(74,222,128,0.10); border:1px solid rgba(74,222,128,0.22);
          border-radius:10px; padding:11px 14px;
          font-size:13px; color:#4ade80; margin-bottom:18px;
        }
        .si-err {
          background:rgba(239,68,68,0.088); border:1px solid rgba(239,68,68,0.26);
          border-radius:10px; padding:11px 14px;
          font-size:13px; color:#fca5a5; margin-bottom:18px;
          animation:errShake .28s ease;
        }
        @keyframes errShake { 0%,100%{transform:translateX(0)} 30%{transform:translateX(-5px)} 70%{transform:translateX(5px)} }
        .si-fld { margin-bottom:16px; }
        .si-lbl { display:block; font-size:12px; font-weight:500; color:rgba(255,255,255,0.5); margin-bottom:7px; letter-spacing:0.02em; }
        .si-iw { position:relative; }
        .si-inp {
        ...
        .si-inp::placeholder { color:rgba(255,255,255,0.2); }
        .si-inp:hover:not(:focus) { border-color:rgba(255,255,255,0.16); background:rgba(255,255,255,0.06); }
        .si-inp:focus { border-color:#ea580c; background:rgba(234,88,12,0.052); box-shadow:0 0 0 3px rgba(234,88,12,0.13); }
        .si-inp-pr { padding-right:40px; }
        .si-ico { position:absolute; left:12px; top:50%; transform:translateY(-50%); color:rgba(255,255,255,0.26); width:16px; height:16px; pointer-events:none; transition:color .2s; }
        .si-iw:focus-within .si-ico { color:#ea580c; }
        .si-eye-btn { position:absolute; right:11px; top:50%; transform:translateY(-50%); background:none; border:none; color:rgba(255,255,255,0.26); cursor:pointer; display:flex; align-items:center; padding:2px; transition:color .2s; }
        .si-eye-btn:hover { color:rgba(255,255,255,0.58); }
        .si-row-mid { display:flex; align-items:center; justify-content:space-between; margin:6px 0 20px; }
        .si-rem { display:flex; align-items:center; gap:7px; cursor:pointer; }
        .si-rem input { accent-color:#ea580c; width:13px; height:13px; cursor:pointer; }
        .si-rem span { font-size:12.5px; color:rgba(255,255,255,0.42); user-select:none; }
        .si-frg { font-size:12.5px; font-weight:500; color:#fb923c; text-decoration:none; transition:color .2s; }
        .si-frg:hover { color:#fdba74; }
        .si-btn {
        ...
        .si-btn::after { content:''; position:absolute; inset:0; background:linear-gradient(135deg,#f97316,#ea580c); opacity:0; transition:opacity .22s; }
        .si-btn:hover:not(:disabled)::after { opacity:1; }
        .si-btn:hover:not(:disabled) { transform:translateY(-2px); box-shadow:0 10px 26px rgba(234,88,12,0.36); }
        .si-btn:active:not(:disabled) { transform:translateY(0); }
        .si-btn:disabled { opacity:0.44; cursor:not-allowed; }
        .si-btn-in { position:relative; z-index:1; display:flex; align-items:center; gap:7px; }
        .si-div { display:flex; align-items:center; gap:11px; margin:20px 0; }
        .si-dline { flex:1; height:1px; background:rgba(255,255,255,0.075); }
        .si-dtxt { font-size:11px; color:rgba(255,255,255,0.26); letter-spacing:0.1em; }
        .si-soc {
        ...
        .si-soc:last-child { margin-bottom:0; }
        .si-soc:hover { background:rgba(255,255,255,0.055); border-color:rgba(255,255,255,0.16); transform:translateY(-1px); }
        .si-ft { margin-top:22px; text-align:center; font-size:13px; color:rgba(255,255,255,0.3); }
        .si-ft a { color:#fb923c; font-weight:600; text-decoration:none; transition:color .2s; }
        .si-ft a:hover { color:#fdba74; }
      ...
      <div className="si-page">
        ...
        <div className="si-right">
          <div className="si-card">
            ...
            {/* ── ADDED: Success message from signup redirect ── */}
            {successMessage && (
              <div className="si-success">✅ {successMessage}</div>
            )}

            {error && <div className="si-err"><p>{error}</p></div>}
