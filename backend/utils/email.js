...
const sendVerificationEmail = async (user, verificationToken) => {
  ...
  const htmlContent = `
    ...
    <head>
      <style>
        ...
        .header { background: linear-gradient(135deg, #FF9933 0%, #FFB366 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; }
        .content { background: white; padding: 30px; border-radius: 0 0 10px 10px; }
        .button { display: inline-block; background: linear-gradient(135deg, #FF9933 0%, #FFB366 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 5px; margin: 20px 0; font-weight: bold; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>If you didn't create an account with Ganpati Handloom, please ignore this email.</p>
          <p>Best regards,<br><strong>Ganpati Handloom Team</strong></p>
        </div>
        <div class="footer">
          <p>© ${new Date().getFullYear()} Ganpati Handloom. All rights reserved.</p>
          <p>Authentic handloom products crafted with love by skilled artisans.</p>
  ...
  try {
    ...
    console.log('✅ Verification email sent via Resend to:', user.email, result);
    return true;
  } catch (error) {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>If you have any questions, feel free to contact our support team.</p>
            <p>Happy shopping!<br><strong>Ganpati Handloom Team</strong></p>
          </div>
        </div>
      </body>
      </html>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.FRONTEND_URL}/orders/${order._id}" style="display: inline-block; background: linear-gradient(135deg, #FF9933 0%, #FFB366 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                Track Your Order
              </a>
            </div>
            <p>We'll send you another email when your order ships!</p>
    ...
    html: `
      ...
      <head>
        <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
          .container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; }
          .header { background: linear-gradient(135deg, #2196F3 0%, #64B5F6 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; }
          .content { background: white; padding: 30px; border-radius: 0 0 10px 10px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="background: #e3f2fd; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: center;">
              <p style="font-size: 14px; color: #666; margin: 0 0 10px 0;">Order ID</p>
              <p style="font-size: 24px; font-weight: bold; color: #2196F3; margin: 0;">#${order._id.toString().slice(-8).toUpperCase()}</p>
            </div>
            ${order.estimatedDelivery ? `<p style="text-align: center; font-size: 16px;"><strong>Expected Delivery:</strong> ${new Date(order.estimatedDelivery).toLocaleDateString()}</p>` : ''}
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.FRONTEND_URL}/orders/${order._id}" style="display: inline-block; background: linear-gradient(135deg, #2196F3 0%, #64B5F6 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                Track Your Order
              </a>
            </div>
            <p>Thank you for shopping with Ganpati Handloom!</p>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="background: #e8f5e9; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: center;">
              <p style="font-size: 14px; color: #666; margin: 0 0 10px 0;">Order ID</p>
              <p style="font-size: 24px; font-weight: bold; color: #4CAF50; margin: 0;">#${order._id.toString().slice(-8).toUpperCase()}</p>
              <p style="margin: 15px 0 0 0; color: #666;">Delivered on ${new Date(order.deliveredAt || Date.now()).toLocaleDateString()}</p>
            </div>
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.FRONTEND_URL}/orders/${order._id}" style="display: inline-block; background: linear-gradient(135deg, #4CAF50 0%, #81C784 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                View Order Details
              </a>
            </div>
            <p>We'd love to hear your feedback! Please leave a review for the products you purchased.</p>
